...
public class NearestGameWidgetIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            views.setImageViewResource(R.id.home_crest, Utilies.getTeamCrestByTeamName(this, homeName));
            views.setImageViewResource(R.id.away_crest, Utilies.getTeamCrestByTeamName(this, awayName));
